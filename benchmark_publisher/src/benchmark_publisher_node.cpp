...
void odom_callback(const nav_msgs::OdometryConstPtr &odom_msg)
{
    ...
    cout << "the base Tgt = " << endl << baseTgt << endl;
    cout << "the base Bgt = " << endl << baseRgt.normalized().toRotationMatrix() << endl;
}
...
int main(int argc, char **argv)
{
    ...
    std::cout << "load point cloud" << cloud_name << std::endl;
    ...
    {
        ROS_INFO("Point cloud data size: %d", (int)cloud->points.size());
    }

    // dose it need to the initial pose transform????
